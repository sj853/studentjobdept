...
document.writeln('<input type="hidden" name="client" value="pub-8003393467285634"></input>');
...
document.writeln('<option value="1">Õ¾ÄÚËÑË÷</option>');
document.writeln('<option value="0">ÍøÒ³ËÑË÷</option>');
