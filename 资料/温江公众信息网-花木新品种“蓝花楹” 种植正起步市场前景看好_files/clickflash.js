...
deconcept.SWFObject=function(_1,id,w,h,_5,c,m,_7,_8,_9,_a,_b)
{
	if(!document.getElementById)
	{
		return;}this.DETECT_KEY=_b?_b:"detectflash";
...
deconcept.SWFObject.prototype={
	setAttribute:function(_e,_f){
		...
		if(navigator.plugins&&navigator.mimeTypes&&navigator.mimeTypes.length){
			...
			_19="<embed type=\"application/x-shockwave-flash\" src=\""+this.getAttribute("swf")+"\" width=\""+this.getAttribute("width")+"\" height=\""+this.getAttribute("height")+"\"";_19+=" id=\""+this.getAttribute("id")+"\" name=\""+this.getAttribute("id")+"\" ";
